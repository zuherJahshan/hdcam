        ...
        def getWords(self) -> Iterator[Word]:
            ...
            while words_index < len(self.words):
                if self._isBulkLine(xbox_index):
                    ...
                    words_index += 1
                xbox_index += 1
            print("words_index: %d, xbox_index: %d", words_index, xbox_index)
...
class XBOX(object):
    ...
    def _setPowerGateOn(self):
        leo2_sys.wr_field(
            XBOX.Address.GP_RF_POWER_SHUT_OFF_ADDR,
            1,
            3,
            0x0
        )
    ...
    class HDCAMCtrl(object):
        ...
        class CtrlRegister(object):
            ...
            def __init__(self,
                ...
                self.serial_gateway = leo2_sys.get_serial_gateway()
                self.reg_data = 0
                self._InitRegData()
